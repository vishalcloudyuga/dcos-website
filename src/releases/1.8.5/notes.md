...
- [#828](https://github.com/dcos/dcos/pull/828) - "Add new aws_masters_have_public_ip configuration option"
...
- [#708](https://github.com/dcos/dcos/pull/708) - "Squash ext/dcos-installer into the base dcos python package"
